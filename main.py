...
def filter_reference():
    ...
    time.sleep(2)
    while True:
        output1[0] = .98*(output1[0]+reference_gyro_omega[0]*DT)+.02*(360/(2*math.pi))*(math.atan2(reference_accelerometer_acc['y'], reference_accelerometer_acc['z'])+math.pi)
        ...
        x1 = output1[0] + offset1[0] 
        z1 = output1[1] + offset1[1]
        y1 = output1[2] + offset1[2]
        iterations += 1    
        time.sleep(DT)
        if iterations == 1000:
            offset1[0] = +0.0 - output1[0]
            offset1[1] = +0.0 - output1[1]
            offset1[2] = +0.0 - output1[2]
