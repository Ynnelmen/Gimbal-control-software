...
PWM_FREQ = 1000 # set master PWM refresh rate (motors only)
...
def motorX(): # controls x-axis
    ...
    while True:
        ...
        xpos = 2*(int(x) - int(output1[0])) # calculates requested output
...
def motorY(): # controls y-axis
    ...
    while True:
        ...
        ypos = 2*(int(y) - int(output1[1])) # calculates requested output
